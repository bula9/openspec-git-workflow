---
name: abort
description: Abandon an in-progress change — archive as ABORTED, delete the Git branch, and switch back to main. Use when the user wants to give up on a change that isn't working out.
...
**Input**: Optionally specify a change name (e.g., `/opsx:abort add-oauth-login`). If omitted:
